...
CREATE TABLE tb_exercicios (
  ...
  exe_musculo enum('Bíceps', 'Tríceps', 'Antebraço', 'Ombro', 'Peito', 'Costa', 'Abdômen', 'Quadríceps', 'Isquiotibiais', 'Glúteo', 'Panturrilha', 'Miscelânea'),
...
insert into tb_funcionarios (fun_cpf, fun_nome, fun_telefone, fun_senha, fun_cargo, fun_ativo) values ('12345678909', 'Admin', '11123456789', 'admin', 'Dono', 'S');
insert into tb_funcionarios (fun_cpf, fun_nome, fun_telefone, fun_senha, fun_cargo, fun_ativo) values ('11144477735', 'Ex-Admin', '12345678999', 'exadmin', 'Instrutor', 'N');